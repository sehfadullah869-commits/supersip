...
import { s as Subscribable, t as shallowEqualObjects, v as hashKey, w as getDefaultState, x as notifyManager, y as useQueryClient, r as reactExports, z as noop, A as shouldThrowError, E as useActor, F as useQuery, G as createActor } from "./index-BrhKsGWM.js";
...
function useOrderById(id, enabled) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
function useStripeSessionStatus(sessionId, enabled) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
export {
  ...
  useProductById as b,
  useCreateOrder as c,
  useCreateCheckoutSession as d,
  useStripeSessionStatus as e,
  useMyOrders as f,
  useOrderById as g,
  useAllProductsAdmin as h,
  useAllOrders as i,
  useDeleteProduct as j,
